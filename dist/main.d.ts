 ...
 */
declare function getClientsNow(verbosity?: Verbosity, timeoutMs?: number): Promise<ClientStatus[]>;
 ...
 */
declare function startClientPolling(interval?: number, verbosity?: Verbosity, onUpdateOrOptions?: UpdateCallback | PollingOptions): Promise<void>;
